...
Plugin URI: http://websiteonlinestudio.com
Description: Lightbox Image Gallery allow you to create lightbox image gallery with caption support and ability to add a slideshow or alternate URL.
Version: 1.0.0
Author: website online studio
Author URI: http://websiteonlinestudio.com
*/


if ( ! class_exists( 'WP_Lightbox_Image_Gallery', false ) ) :

class WP_Lightbox_Image_Gallery {
	 ...
	 * @since 1.2.24
	 */
	const PLUGIN_NAME = 'WP Lightbox Image Gallery';
	 ...
	 * @since 1.2.24
	 */
	const PLUGIN_SLUG = 'wp_lightbox-image-gallery';
	 ...
	 * @since 1.2.24
	 */
	const PLUGIN_PREFIX = 'wp_lightbox_image_image_gallery';
	 ...
	 * @since 1.2.24
	 */
	const OPTIONS_PAGE_SLUG = 'wp_lightbox_image_image_gallery_options';
	...
	public function _display_redux_dependency_notice() {
		...
		if ( ! get_user_meta( $current_user->ID, 'setting_error_' . self::PLUGIN_PREFIX . '_redux_framework_dismiss' ) and 'plugins.php' == $pagenow and current_user_can( 'install_plugins' ) ) :
			...
			if ( ! self::_is_plugin_active( 'redux-framework', 'redux-framework.php' ) ) :
				...
				echo sprintf( __( '%1$s uses the %2$s plugin to change default settings.', 'wp_lightbox-image-gallery' ), '<strong>' . self::PLUGIN_NAME . '</strong>','<a href="http://wordpress.org/plugins/redux-framework/" target="_blank">Redux Framework</a>' );
				echo '<a href="?setting_error_' . self::PLUGIN_PREFIX . '_redux_framework_dismiss=0" style="float:right;">' . __( 'Dismiss', 'wp_lightbox-image-gallery' ) . '</a>';
				echo '</p></div>';
			endif;
	...
	public function _init_redux_arguments() {
		...
		$this->args = array(
			...
			'menu_title'			=> __( 'Image Gallery', 'wp_lightbox-image-gallery' ),
	...
	public function _init_sections() {
		...
		$this->sections[] = array(
			'title' => __('Gallery', 'wp_lightbox-image-gallery'),
			'desc' => __('Specify the layout and attributes of the gallery grid of images.', 'wp_lightbox-image-gallery'),
			'icon' => 'el-icon-book',
		    'submenu' => true,
			'fields' => array(	
				array(
					'id'=>'container',
					'type' => 'radio',
					'title' => __( 'Container', 'wp_lightbox-image-gallery' ),
					'subtitle' => 'container="true"',
					'desc' => __( 'The HTML tag containing the gallery grid.', 'wp_lightbox-image-gallery' ),
					'options' => array( 'div' => __( 'Division (default)', 'wp_lightbox-image-gallery' ), 'span' => __( 'Span', 'wp_lightbox-image-gallery' ) ),
					'default' => 'div',
					),
				array(
					'id'=>'columns',
					'type' => 'slider', 
					'title' => __( 'Columns', 'wp_lightbox-image-gallery' ),
					'subtitle' => 'columns="3"',
					'desc' => __( 'Number of columns making up the grid of images.', 'wp_lightbox-image-gallery' ),
					'min' => '1',
					'step' => '1',
					'max' => '9',
					'default' => '3',
				...
				array(
					'id'=>'heading',
					'type' => 'checkbox',
					'title' => __( 'Image Title', 'wp_lightbox-image-gallery' ), 
					'subtitle' => 'heading="false"',
					'desc' => __( 'The title appears just below the image in the gallery grid and after the image counter in the slideshow.', 'wp_lightbox-image-gallery' ),
					'options' => array( self::CHECKBOX_DEFAULT_KEY => __( 'Display the image title', 'wp_lightbox-image-gallery' ) ),
					'default' => array( self::CHECKBOX_DEFAULT_KEY => '0' ),
					),
				array(
					'id'=>'headingtag',
					'type' => 'select',
					'title' => __( 'Image Title Tag', 'wp_lightbox-image-gallery' ), 
					'subtitle' => 'headingtag="h2"',
					'desc' => __( 'The HTML tag used to wrap the image title.', 'wp_lightbox-image-gallery' ),
				...
				array(
					'id'=>'caption',
					'type' => 'checkbox',
					'title' => __( 'Caption', 'wp_lightbox-image-gallery' ), 
					'subtitle' => 'caption="false"',
					'desc' => __( 'The caption appears just below the image in the gallery grid and after the image counter and image title in the slideshow.', 'wp_lightbox-image-gallery' ),
					'options' => array( self::CHECKBOX_DEFAULT_KEY => __( 'Display the caption', 'wp_lightbox-image-gallery' ) ),
					'default' => array( self::CHECKBOX_DEFAULT_KEY => '0' ),
					),
				array(
					'id'=>'caption_auto_format',
					'type' => 'checkbox',
					'title' => __( 'Caption Auto Format', 'wp_lightbox-image-gallery' ), 
					'subtitle' => 'caption_auto_format="false"',
					'desc' => __( 'Automatically insert break and paragraph tags into caption.', 'wp_lightbox-image-gallery' ),
					'options' => array( self::CHECKBOX_DEFAULT_KEY => __( 'Automatically format the caption', 'wp_lightbox-image-gallery' ) ),
					'default' => array( self::CHECKBOX_DEFAULT_KEY => '0' ),
					),
				array(
					'id'=>'caption_source',
					'type' => 'radio',
					'title' => __( 'Caption Source', 'wp_lightbox-image-gallery' ), 
					'subtitle' => 'caption_source="caption"',
					'desc' => __( 'Specify the source of the text displayed as the caption.', 'wp_lightbox-image-gallery' ),
					'options' => array( 'caption' => __( 'Caption (default)', 'wp_lightbox-image-gallery' ), 'description' => __( 'Description', 'wp_lightbox-image-gallery' ) ),
					'default' => 'caption',
					),
				array(
					'id'=>'caption_align',
					'type' => 'radio',
					'title' => __( 'Caption Alignment', 'wp_lightbox-image-gallery' ), 
					'subtitle' => 'caption_align="left"',
					'desc' => __( 'Specify the alignment of the caption text for the gallery.', 'wp_lightbox-image-gallery' ),
					'options' => array( 'left' => __( 'Left (default)', 'wp_lightbox-image-gallery' ), 'center' => __( 'Center', 'wp_lightbox-image-gallery' ), 'right' => __( 'Right', 'wp_lightbox-image-gallery' ) ),
					'default' => 'left',
					),
				array(
					'id'=>'align',
					'type' => 'radio',
					'title' => __( 'Image Alignment', 'wp_lightbox-image-gallery' ), 
					'subtitle' => 'align="left"',
					'desc' => __( 'Specify the alignment of the last row of images if there are not enough to complete the row.', 'wp_lightbox-image-gallery' ),
					'options' => array( 'left' => __( 'Left (default)', 'wp_lightbox-image-gallery' ), 'center' => __( 'Center', 'wp_lightbox-image-gallery' ), 'right' => __( 'Right', 'wp_lightbox-image-gallery' ) ),
					'default' => 'left',
					),
				array(
					...
					'type' => 'checkbox',
					'title' => __( 'Background Thumbnails', 'wp_lightbox-image-gallery' ), 
					'subtitle' => 'background_thumbnails="false"',
					'desc' => __( 'Images displayed as backgrounds have greater flexibility when styled with CSS.', 'wp_lightbox-image-gallery' ),
					'options' => array( self::CHECKBOX_DEFAULT_KEY => __( 'Display gallery images as backgrounds', 'wp_lightbox-image-gallery' ) ),
					'default' => array( self::CHECKBOX_DEFAULT_KEY => '0' ),
					),
				array(
					'id'=>'link',
					'type' => 'radio',
					'title' => __( 'Link', 'wp_lightbox-image-gallery' ), 
					'subtitle' => 'link="permalink"',
					'desc' => __( 'Default behavior when clicking a gallery image if a Gallery Link URL is not set or slideshow mode is disabled.', 'wp_lightbox-image-gallery' ),
		...
		$this->sections[] = array(
			'title' => __('Slideshow', 'wp_lightbox-image-gallery'),
			'desc' => __('Define the slideshow behavior.', 'wp_lightbox-image-gallery'),
			...
			'fields' => array(
				array(
					...
					'desc' => __( 'Causes the slideshow window to display when a gallery image is clicked.', 'wp_lightbox-image-gallery' ),
					'options' => array( self::CHECKBOX_DEFAULT_KEY => __( 'Activate the slideshow', 'wp_lightbox-image-gallery' ) ),
					'default' => array( self::CHECKBOX_DEFAULT_KEY => '1' ),
					),
				array(
					'id'=>'fb_title_show',
					'type' => 'checkbox',
					'title' => __( 'Title', 'wp_lightbox-image-gallery' ), 
					'subtitle' => 'fb_title_show="true"', 
					'desc' => __( 'The title area may include the image counter, image title, caption text and EXIF data.', 'wp_lightbox-image-gallery' ),
					'options' => array( self::CHECKBOX_DEFAULT_KEY => __( 'Show the slideshow title area', 'wp_lightbox-image-gallery' ) ),
					'default' => array( self::CHECKBOX_DEFAULT_KEY => '1' ),
					),
				array(
					'id'=>'fb_title_position',
					'type' => 'radio',
					'title' => __( 'Title Position', 'wp_lightbox-image-gallery' ), 
					'subtitle' => 'fb_title_position="over"', 
					'desc' => __( 'Where the title area should appear.', 'wp_lightbox-image-gallery' ),
					'options' => array( 'over' => __( 'Over the image (default)', 'wp_lightbox-image-gallery' ), 'outside' => __( 'Below the slide', 'wp_lightbox-image-gallery' ), 'inside' => __( 'Below the image', 'wp_lightbox-image-gallery' ) ),
					'default' => 'over',
					),
				array(
					'id'=>'fb_title_align',
					'type' => 'radio',
					'title' => __( 'Title Alignment', 'wp_lightbox-image-gallery' ), 
					'subtitle' => 'fb_title_align="none"', 
					'desc' => __( 'Alignment of text in the title area.', 'wp_lightbox-image-gallery' ),
					'options' => array( 'none' => __( 'None (default)', 'wp_lightbox-image-gallery' ), 'left' => __( 'Left', 'wp_lightbox-image-gallery' ), 'center' => __( 'Center', 'wp_lightbox-image-gallery' ), 'right' => __( 'Right', 'wp_lightbox-image-gallery' ) ),
					'default' => 'none',
					),
				array(
					'id'=>'fb_title_counter_show',
					'type' => 'checkbox',
					'title' => __( 'Image Counter', 'wp_lightbox-image-gallery' ), 
					'subtitle' => 'fb_title_counter_show="true"', 
					'desc' => __( 'The image counter displays the word "Image" followed by the image number and total count.', 'wp_lightbox-image-gallery' ),
					'options' => array( self::CHECKBOX_DEFAULT_KEY => __( 'Show the image counter', 'wp_lightbox-image-gallery' ) ),
					'default' => array( self::CHECKBOX_DEFAULT_KEY => '1' ),
					),
				array(
					'id'=>'fb_center_on_scroll',
					'type' => 'checkbox',
					'title' => __( 'Slideshow Position', 'wp_lightbox-image-gallery' ), 
					'subtitle' => 'fb_center_on_scroll="true"', 
					'desc' => __( 'Specifies the slideshow behavior when a browser window scrolled or resized.', 'wp_lightbox-image-gallery' ),
					'options' => array( self::CHECKBOX_DEFAULT_KEY => __( 'Keep the slideshow centered', 'wp_lightbox-image-gallery' ) ),
					'default' => array( self::CHECKBOX_DEFAULT_KEY => '1' ),
					),
				array(
					'id'=>'fb_cyclic',
					'type' => 'checkbox',
					'title' => __( 'Loop', 'wp_lightbox-image-gallery' ), 
					'subtitle' => 'fb_cyclic="true"', 
					'options' => array( self::CHECKBOX_DEFAULT_KEY => __( 'Start over when reaching the end of the slideshow', 'wp_lightbox-image-gallery' ) ),
					'default' => array( self::CHECKBOX_DEFAULT_KEY => '1' ),
					),
				array(
					'id'=>'fb_transition_in',
					'type' => 'radio',
					'title' => __( 'Transition In', 'wp_lightbox-image-gallery' ), 
					'subtitle' => 'fb_transition_in="true"', 
					'desc' => __( 'Effect when slideshow is opened.', 'wp_lightbox-image-gallery' ),
					'options' => array( 'none' => __( 'None (default)', 'wp_lightbox-image-gallery' ), 'elastic' => __( 'Elastic', 'wp_lightbox-image-gallery' ), 'fade' => __( 'Fade', 'wp_lightbox-image-gallery' ) ),
					'default' => 'none',
					),
				array(
					'id'=>'fb_speed_in',
					'type' => 'slider', 
					'title' => __( 'Transition Speed In', 'wp_lightbox-image-gallery' ),
				...
				array(
					...
					'type' => 'radio',
					'title' => __( 'Transition Out', 'wp_lightbox-image-gallery' ), 
					'subtitle' => 'fb_transition_out="true"', 
					'desc' => __( 'Effect when slideshow is closed.', 'wp_lightbox-image-gallery' ),
					'options' => array( 'none' => __( 'None (default)', 'wp_lightbox-image-gallery' ), 'elastic' => __( 'Elastic', 'wp_lightbox-image-gallery' ), 'fade' => __( 'Fade', 'wp_lightbox-image-gallery' ) ),
					'default' => 'none',
					),
				array(
					'id'=>'fb_speed_out',
					'type' => 'slider', 
					'title' => __( 'Transition Speed Out', 'wp_lightbox-image-gallery' ),
				...
				array(
					...
					'type' => 'checkbox',
					'title' => __( 'Close Button', 'wp_lightbox-image-gallery' ), 
					'subtitle' => 'fb_show_close_button="true"', 
					'options' => array( self::CHECKBOX_DEFAULT_KEY => __( 'Show the close button on the slideshow window', 'wp_lightbox-image-gallery' ) ),
					'default' => array( self::CHECKBOX_DEFAULT_KEY => '1' ),
					),
				),
			);
		...
		$this->sections[] = array(
			'title' => __('Image Sizes', 'wp_lightbox-image-gallery'),
			'desc' => __('Specify the image sizes to use in the gallery and slideshow views.', 'wp_lightbox-image-gallery'),
			...
			'fields' => array(	
				array(
					'id'=>'size',
					'type' => 'callback',
					'title' => __( 'Gallery Image Size', 'wp_lightbox-image-gallery' ), 
					'subtitle' => 'size="thumbnail"',
					'desc' => __( 'Specify the image size for the gallery view.', 'wp_lightbox-image-gallery' ),
					'default' => 'thumbnail',
					'callback' => '_wp_lightbox_image_image_gallery_custom_field_image_sizes',
					),
				array(
					'id'=>'size_large',
					'type' => 'callback',
					'title' => __( 'Slideshow Image Size', 'wp_lightbox-image-gallery' ), 
					'subtitle' => 'size="large"',
					'desc' => __( 'Specify the image size for the slideshow view.', 'wp_lightbox-image-gallery' ),
					'default' => 'large',
					'callback' => '_wp_lightbox_image_image_gallery_custom_field_image_sizes',
					),
				)
		...
		$this->sections[] = array(
			'title' => __('EXIF Data', 'wp_lightbox-image-gallery'),
			'desc' => __('Define if and where EXIF data is displayed.', 'wp_lightbox-image-gallery'),
			...
			'fields' => array(	
				array(
					'id'=>'exif',
					'type' => 'checkbox',
					'title' => __( 'EXIF', 'wp_lightbox-image-gallery' ), 
					'subtitle' => 'exif="false"',
					'options' => array( self::CHECKBOX_DEFAULT_KEY => __( 'Display EXIF data', 'wp_lightbox-image-gallery' ) ),
					'default' => array( self::CHECKBOX_DEFAULT_KEY => '0' ),
					),
				array(
					'id'=>'exif_locations',
					'type' => 'radio',
					'title' => __( 'EXIF Location', 'wp_lightbox-image-gallery' ), 
					'subtitle' => __( 'Define where the EXIF data is displayed.', 'wp_lightbox-image-gallery' ),
					'options' => array( 'slideshow' => __( 'Slideshow (default)', 'wp_lightbox-image-gallery' ), 'gallery' => __( 'Gallery', 'wp_lightbox-image-gallery' ) ),
					'default' => 'slideshow',
					),
				array(
		            'id' => 'exif_fields',
		    	    ...
		    	    'title' => __('Sortable Text Option', 'wp_lightbox-image-gallery'),
		        	'subtitle' => __('Define and reorder these however you want.', 'wp_lightbox-image-gallery'),
					'desc' => __('This is the description field, again good for additional info.', 'wp_lightbox-image-gallery'),
		            'options' => array(
		            	'camera' => __( 'Camera', 'wp_lightbox-image-gallery' ),
		            	'aperture' => __( 'Aperture', 'wp_lightbox-image-gallery' ),
		            	'focal_length' => __( 'Focal Length', 'wp_lightbox-image-gallery' ),
		            	'iso' => __( 'ISO', 'wp_lightbox-image-gallery' ),
		            	'shutter_speed' => __( 'Shutter Speed', 'wp_lightbox-image-gallery' ),
		            	'title' => __( 'Title', 'wp_lightbox-image-gallery' ),
		            	'caption' => __( 'Caption', 'wp_lightbox-image-gallery' ),
		            	'credit' => __( 'Credit', 'wp_lightbox-image-gallery' ),
		            	'copyright' => __( 'Copyright', 'wp_lightbox-image-gallery' ),
		            	'created_timestamp' => __( 'Created Timestamp', 'wp_lightbox-image-gallery' ),
		    	    	),
		        	'default' => array(
		        		'camera' => '1',
		        		'aperture' => '1',
		...
		$this->sections[] = array(
			'title' => __('Sorting', 'wp_lightbox-image-gallery'),
			'desc' => __('The sorting settings only work if the ids shortcode attribute has not been set. Changing the order in the WordPress Gallery editor will add the ids attribute.', 'wp_lightbox-image-gallery'),
			'icon' => 'el-icon-cogs',
		    'submenu' => true,
			'fields' => array(
				array(
					'id'=>'order',
					'type' => 'radio',
					'title' => __( 'Order', 'wp_lightbox-image-gallery' ), 
					'subtitle' => 'order="asc"',
					'options' => array( 'asc' => __( 'Ascending (default)', 'wp_lightbox-image-gallery' ), 'desc' => __( 'Descending', 'wp_lightbox-image-gallery' ) ),
					'default' => 'asc',
					),
				array(
					'id'=>'orderby',
					'type' => 'radio',
					'title' => __( 'Order By', 'wp_lightbox-image-gallery' ), 
					'subtitle' => 'orderby="menu_order"',
					'options' => array( 'menu_order' => __( 'Menu Order (default)', 'wp_lightbox-image-gallery' ), 'title' => __( 'Title', 'wp_lightbox-image-gallery' ), 'post_date' => __( 'Date', 'wp_lightbox-image-gallery' ), 'rand' => __( 'Random', 'wp_lightbox-image-gallery' ), 'ID' => __( 'ID', 'wp_lightbox-image-gallery' ) ),
					'default' => 'menu_order',
					),
				)
			);
	...
	private function _get_defaults() {
		...
		global $_wp_lightbox_image_image_gallery;
		$setting = '';
		...
		if ( isset( $this->fields ) and empty( $defaults_array ) ) :
			...
			foreach( $this->fields as $field ) :
				...
				// the redux framework is active so get the settings from the wp_lightbox_image_image_gallery global
				if ( $this->plugin_active_redux_framework ) :
				
					$setting = $_wp_lightbox_image_image_gallery[$field['id']];
	...
	public function _plugins_loaded() {
		load_plugin_textdomain( 'wp_lightbox-image-gallery', false, trailingslashit( dirname( plugin_basename( __FILE__ ) ) ) . '/lang/' );
	...
	public function _settings_link( $links ) {
	    if ( $this->plugin_active_redux_framework ) :
		    $settings_link = '<a href="' . self::OPTIONS_PAGE_PARENT . '?page=' . self::OPTIONS_PAGE_SLUG . '">' . __( 'Settings', 'wp_lightbox-image-gallery' ) . '</a>';
	...
	public function f_media_edit_gallery_link( $fields, $post ) {
		...
		$fields['post_gallery_link'] = array(
			'label' => __( 'Gallery Link URL', 'wp_lightbox-image-gallery' ),
			'value' => esc_attr( get_post_meta( $post->ID, '_wp_lightbox_image_attachment_post_gallery_link', true ) ),
			'input' => 'text',
			'helps' => __( 'Enter a relative or absolute link that should be followed when the image is clicked<br />from within an image gallery.', 'wp_lightbox-image-gallery' )
		);
	...
	public function f_media_edit_gallery_link_target( $fields, $post ) {
		...
		$target = get_post_meta( $post->ID, '_wp_lightbox_image_attachment_post_gallery_link_target', true );
		$options_inner_html = '';
		...
		$fields['post_gallery_link_target'] = array(
			'label' => __( 'Gallery Link Target', 'wp_lightbox-image-gallery' ),
			'value' => $target,
			'input' => 'html',
			...
			'helps' => __( 'Select the target for the Gallery Link URL.', 'wp_lightbox-image-gallery' )
		);
	...
	public function f_media_save_gallery_link( $post, $fields ) {
		...
		if ( empty( $safe_url ) ) {
			if ( get_post_meta( $post['ID'], '_wp_lightbox_image_attachment_post_gallery_link', true ) ) {
				delete_post_meta( $post['ID'], '_wp_lightbox_image_attachment_post_gallery_link' );
			}
			return $post;
		}
		...
		update_post_meta( $post['ID'], '_wp_lightbox_image_attachment_post_gallery_link', $safe_url );
	...
	public function f_media_save_gallery_link_target( $post, $fields ) {
		...
		if ( empty( $fields['post_gallery_link_target'] ) ) {
			if ( get_post_meta( $post['ID'], '_wp_lightbox_image_attachment_post_gallery_link_target', true ) ) {
				delete_post_meta( $post['ID'], '_wp_lightbox_image_attachment_post_gallery_link_target' );
			}
			return $post;
		}
		
		update_post_meta( $post['ID'], '_wp_lightbox_image_attachment_post_gallery_link_target', $fields['post_gallery_link_target'] );
	...
	public function get_gallery_link( $attachment_id ) {
		return get_post_meta( $attachment_id, '_wp_lightbox_image_attachment_post_gallery_link', true );
	}
	...
	public function get_gallery_link_target( $attachment_id ) {
		return get_post_meta( $attachment_id, '_wp_lightbox_image_attachment_post_gallery_link_target', true );
	}
	...
	public function cb_init() {
		add_shortcode( 'wp_lightbox-image-gallery', array( &$this, 'cb_gallery_shortcode' ) );
		add_shortcode( 'gallery', array( &$this, 'cb_gallery_shortcode' ) );
		
		wp_register_style( 'wp_lightbox-image-gallery-fancybox', plugins_url( 'dependencies/fancybox/jquery.fancybox-1.3.4.css', __FILE__ ), false, '1.0.0' );
		wp_register_style( 'wp_lightbox-image-gallery', plugins_url( 'wp_lightbox-image-gallery.css', __FILE__ ), array( 'wp_lightbox-image-gallery-fancybox' ), self::PLUGIN_VERSION );
		
		wp_register_script( 'wp_lightbox-image-gallery-easing', plugins_url( 'dependencies/fancybox/jquery.easing-1.3.pack.2.js', __FILE__ ), array( 'jquery' ), '1.3', true );
		wp_register_script( 'wp_lightbox-image-gallery-fancybox', plugins_url( 'dependencies/fancybox/jquery.fancybox-1.3.4.pack.js', __FILE__ ), array( 'wp_lightbox-image-gallery-easing' ), '1.3.4', true );
	}
	...
	public function cb_enqueue_styles_scripts() {
		wp_enqueue_style( 'wp_lightbox-image-gallery' );
	}
	...
	public function cb_gallery_shortcode( $atts, $content = null ) {
		...
		$defaults = array(
			'id' => get_the_id(),
			'ids' => '',
			'group_name' => 'wp_lightbox-image-group-' . $post->ID,
			'include' => '',
			'exclude' => '',
		 ...
		 */
		$str_output .= '<' . $container . ' class="wp_lightbox-image-gallery gallery-columns-' . $columns . ' gallery-size-' . $size . '" style="text-align:' . $align . '">';
		...
		foreach ( $attachments as $attachment ) {
			...
			if ($caption_auto_format) {
				$str_caption = wpautop($str_caption);
			}
			...
			$gallery_caption = '';
			$gallery_target = '';
			$str_target = get_post_meta( $attachment->ID, '_wp_lightbox_image_attachment_post_gallery_link_target', true );
			$str_image = '';
			 ...
			 */
			if ( $caption ) $gallery_caption = '<span class="wp-caption-text gallery-caption" style="text-align:' . $_wp_lightbox_image_image_gallery['caption_align'] . '">' . $str_caption . '</span>';
				...
				if ( ! empty( $image_metadata_selected ) ) :
					...
					foreach ( $image_metadata_selected as $meta_key => $meta_value ) :
						...
						if ( ! empty( $meta_value ) ) :
							...
							$meta_value = ( $meta_key == 'aperture' ) ? __( 'f/', 'wp_lightbox-image-gallery' ) . $meta_value : $meta_value;
							$meta_value = ( $meta_key == 'created_timestamp' ) ? date_i18n( get_option( 'date_format' ), $meta_value ) : $meta_value;
							$meta_value = ( $meta_key == 'focal_length' ) ? $meta_value . __( 'mm', 'wp_lightbox-image-gallery' ) : $meta_value;
							$meta_value = ( $meta_key == 'iso' ) ? __( 'ISO', 'wp_lightbox-image-gallery' ) . $meta_value : $meta_value;
							$meta_value = ( $meta_key == 'shutter_speed' ) ? round( $meta_value, 4 ) . __( 's', 'wp_lightbox-image-gallery' ) : $meta_value;
	...
	public function cb_footer_styles_scripts () {
		...
		global $_wp_lightbox_image_image_gallery;
		wp_print_scripts( 'wp_lightbox-image-gallery-fancybox' );
		...
		if ( 'none' !== $_wp_lightbox_image_image_gallery['fb_title_align'] ) :
			echo '<style type="text/css">#fancybox-title{text-align:' . $_wp_lightbox_image_image_gallery['fb_title_align'] . ' !important;}</style>';		
		endif;
	...
	if ( ! isset( $wp_lightbox_image_image_gallery ) ) $wp_lightbox_image_image_gallery = new WP_Lightbox_Image_Gallery;
	 ...
	 * @since 1.2.24
	 */
	function _wp_lightbox_image_gallery_custom_field_image_sizes( $field, $value ) {
		...
		$image_sizes['full'] = __( 'Original File', 'wp_lightbox-image-gallery' );
		
		echo '<select  id="' . $field['id'] . '-select" data-placeholder="' . _x( 'Select an item', 'select menu data placeholder text for image size fields', 'wp_lightbox-image-gallery' ) . '" name="_wp_lightbox_image_gallery['. $field['id'] .']" class="redux-select-item " style="width: 40%;" rows="6">';
		echo '<option></option>';
